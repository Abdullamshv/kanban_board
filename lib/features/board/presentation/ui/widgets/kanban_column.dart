              ...
              itemBuilder: (context, index) {
                    ...
                    builder: (context, candidateData, rejectedData) {
                      ...
                      return AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: isHovered 
                              ? Border.all(color: Colors.blue.withValues(alpha: 0.4), width: 2)
                              : null,
                        ),
                        child: isHovered 
                            ? const Center(child: Icon(Icons.download, color: Colors.blue))
                            : (widget.tasks.isEmpty 
                                ? const Center(child: Text("Drop here", style: TextStyle(color: Colors.black26))) 
                                : null),
                      );
                    },
                  );
                ...
                return DragTarget<TaskModel>(
                  onWillAcceptWithDetails: (details) =>
                      details.data.indicatorToMoId != task.indicatorToMoId,
                  onAcceptWithDetails: (details) {
                    ref.read(boardProvider.notifier).moveTask(
                      task: details.data,
                      newParentId: widget.folderId,
